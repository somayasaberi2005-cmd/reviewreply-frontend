...
const features = [
  { icon: Sparkles, text: "AI replies that sound like you, not a robot" },
  { icon: ShieldCheck, text: "Sensitive reviews always go to a real person first" },
  { icon: TrendingUp, text: "See sentiment and response trends at a glance" },
];
    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-b from-slate-900 to-stone-900 p-12 flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-2">
          <div className="w-9 h-9 rounded-lg bg-berry-400 flex items-center justify-center">
            <MessageSquareText size={18} className="text-slate-900" />
          </div>
        ...
        <div className="relative z-10">
          ...
          <p className="text-stone-300 text-sm max-w-sm mb-10">
            ReviewReply drafts and posts on-brand replies to your Google reviews the moment they come in, so your team can focus on the ones that need a human touch.
          </p>
              ...
              return (
                <div key={feature.text} className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-white/10 backdrop-blur-sm flex items-center justify-center flex-shrink-0">
                    <Icon size={15} className="text-berry-400" />
                  </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-slate-50 px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-xs text-slate-400 text-center mt-5">
            Preview build &mdash; sign in takes you straight to the dashboard.
          </p>
        </div>
      </div>
    </div>
